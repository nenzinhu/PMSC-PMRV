# Pmrv - Otimização & Agilidade

Este repositório contém a versão melhorada do projeto **Pmrv**, uma ferramenta para registro de danos veiculares e geração de relatórios. As principais melhorias incluem:
